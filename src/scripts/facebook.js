...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const toggleModal = (show) => {
    ...
    if (show) {
      ...
      setTimeout(() => {
        const focusable = createPostModal.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');
  ...
  if (createPostBtn) createPostBtn.addEventListener('click', () => toggleModal(true));
