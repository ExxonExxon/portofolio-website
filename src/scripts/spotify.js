...
const ALBUM_DATA = [
  { id: 1, title: "Midnight City", artist: "M83", img: "/spotify-clone/songs-photos/midnight-city.jpeg" },
  { id: 2, title: "Starboy", artist: "The Weeknd", img: "/spotify-clone/songs-photos/the-weeknd-starboy.png" },
  { id: 3, title: "After Hours", artist: "The Weeknd", img: "/spotify-clone/songs-photos/the-weeknd-after-hours.png" },
  { id: 4, title: "Currents", artist: "Tame Impala", img: "/spotify-clone/songs-photos/tame-impala-currents.png" },
  { id: 5, title: "Plastic Beach", artist: "Gorillaz", img: "/spotify-clone/songs-photos/plastic-beach.jpeg" },
  { id: 6, title: "Runner", artist: "Djo", img: "/spotify-clone/songs-photos/djo-runner.jpg" },
  { id: 7, title: "Levitating", artist: "Dua Lipa", img: "/spotify-clone/songs-photos/levitating-dua-lipa.png" },
  { id: 8, title: "Beat It", artist: "Michael Jackson", img: "/spotify-clone/songs-photos/beat-it.jpg" }
];
...
masterPlayBtn.addEventListener('click', () => {
  ...
  masterPlayBtn.setAttribute('aria-label', isPlaying ? 'Play current song' : 'Pause current song');
  isPlaying = !isPlaying;
  createIcons();
});
