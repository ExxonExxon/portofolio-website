 ...
 */
const LIBRARY_DATA = [
    { name: "Lofi Beats", type: "Playlist", author: "Tomas", img: "https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=150&h=150&fit=crop" },
    { name: "Gym Hype", type: "Playlist", author: "Spotify", img: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=150&h=150&fit=crop" },
    { name: "Coding Focus", type: "Album", author: "Deep Focus", img: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=150&h=150&fit=crop" },
    { name: "The Weeknd", type: "Artist", author: "Verified", img: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?w=150&h=150&fit=crop" },
    { name: "Tame Impala", type: "Artist", author: "Verified", img: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=150&h=150&fit=crop" }
];

const ALBUM_DATA = [
    { id: 1, title: "Midnight City", artist: "M83", img: "Songs Photos/Midnight_city.jpeg" },
    { id: 2, title: "Starboy", artist: "The Weeknd", img: "Songs Photos/The_Weeknd_-_Starboy.png" },
    { id: 3, title: "After Hours", artist: "The Weeknd", img: "Songs Photos/The_Weeknd_-_After_Hours.png" },
    { id: 4, title: "Currents", artist: "Tame Impala", img: "Songs Photos/Tame_Impala_-_Currents.png" },
    { id: 5, title: "Plastic Beach", artist: "Gorillaz", img: "Songs Photos/plastic beach.jpeg" },
    { id: 6, title: "Runner", artist: "Djo", img: "Songs Photos/djo runner.jpg" },
    { id: 7, title: "Levitating", artist: "Dua Lipa", img: "Songs Photos/levitating dua lipa.png" },
    { id: 8, title: "Beat It", artist: "Michael Jackson", img: "Songs Photos/Beat_It.jpg" }
];
...
function initLibrary() {
    playlistContainer.innerHTML = LIBRARY_DATA.map(item => `
...
function renderContent(filter = "") {
    const results = ALBUM_DATA.filter(a => 
        a.title.toLowerCase().includes(filter.toLowerCase()) || 
        a.artist.toLowerCase().includes(filter.toLowerCase())
    );

    document.getElementById('search-count').classList.toggle('hidden', filter === "");
    clearBtn.classList.toggle('hidden', filter === "");
    
    albumGrid.innerHTML = results.map(album => `
...
masterPlayBtn.addEventListener('click', () => {
    if (isPlaying) {
        ...
        masterPlayBtn.setAttribute('aria-label', 'Play current song');
        isPlaying = false;
    } else {
        // If no song is selected, perhaps do nothing or play a default
        // For now, assume a song is selected if the button is clicked.
        masterIcon.setAttribute('data-lucide', 'pause');
        masterPlayBtn.setAttribute('aria-label', 'Pause current song');
        isPlaying = true;
    }
...
clearBtn.onclick = () => { searchInput.value = ""; renderContent(""); };

// Sidebar Toggle Mobile Logic
...
document.addEventListener('DOMContentLoaded', () => {
    initLibrary();
    renderContent();
    updateIcons(); // Ensure all static lucide icons are processed
});